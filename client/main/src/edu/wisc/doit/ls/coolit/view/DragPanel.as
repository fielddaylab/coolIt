package edu.wisc.doit.ls.coolit.view
{
	...
	public class DragPanel extends Panel
	{
		...
		override protected function updateDisplayList(unscaledWidth:Number, unscaledHeight:Number):void
		{
			...
			closeShape.graphics.lineStyle(3);
			closeShape.graphics.beginFill(0xFFFFFF, 0.0);
			closeShape.graphics.moveTo(unscaledWidth - 11,4);
			closeShape.graphics.lineTo(unscaledWidth - 4,11);
			closeShape.graphics.moveTo(unscaledWidth - 4,4);
			closeShape.graphics.lineTo(unscaledWidth - 11, 11);
			*/
