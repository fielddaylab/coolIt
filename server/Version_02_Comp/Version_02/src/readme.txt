 	...
 	B. Set the path by doing one of the following:
		...
		* Add the MCR directory to the environment variable by issuing 
         ...
         NOTE: When deploying C and C++ standalone applications, it is possible
               to run the shell script file run_Version_02.sh on UNIX and Mac
...
3. Collect the following files, based on what you are deploying: 
	...
	All Platforms:
		* Version_02.ctf (Component Technology File archive,
		  platform-dependent on target machine)
			
        Windows:
		* MCRInstaller.exe (self-extracting MATLAB Component Runtime
		  library installer)   
		* Version_02.exe (application created by MATLAB Compiler)
        UNIX:
		* MCRInstaller.bin (MATLAB Component Runtime library 
	 	  installer)
		* Version_02 (application created by MATLAB Compiler)
		* run_Version_02.sh (shell script that can be run 
	...
	All Platforms:            
		* Version_02.dll (shared library, file extension 
		  varies by platform)
		* Version_02.h (library header file)
		* Version_02.ctf (Component Technology File archive,
	...
	* Version_02.xml (documentation files)
	* Version_02.pdb (program database file - if 
	  DEBUG option selected)
	* Version_02.dll (component assembly file)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  
	...
	* Version_02.ctf (Component Technology File archive, 
	  contains compiled M-code)
	* Version_02_0_0.dll (COM component)
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  	
	...
	* Version_02.jar (Java class files and compiled M-code)
	...
	* Version_02.ctf (Component Technology File archive, 
	  contains compiled M-code)
	* Version_02.xla (Optionally created and placed in
	  C:\Users\mike\Documents\Visual Studio 2005\Projects\CoolIt\Version_02_Comp\Version_02\src directory by the user)  
	* MCRInstaller.exe (self-extracting MATLAB Component Runtime
	  library archive)  	
